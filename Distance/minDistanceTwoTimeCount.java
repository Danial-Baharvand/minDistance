...
public class minDistanceTwoTimeCount {
    ...
    static long time;
    static long minDistanceTwoTimeCount(int[] A) {
    ...
    public static void writeTime(int[] myArray)throws IOException{
        BufferedWriter writer = new BufferedWriter(new FileWriter("timeResultsTwo.txt", true));
    ...
    public static void main(String[] args) throws IOException {
        ...
        minDistanceTwoTimeCount(myArray);
        //Print to console
